...
ItemCrawled, whose Outcome decides inserted/updated — None ⇒ INSERTED.

BatchCompleted → sink.flush() runs UNGUARDED on purpose: a flush failure
    ...
    async for event in events:
        ...
        match event:
            ...
            case ContentRefreshed():
                ...
                result.updated += 1
            case ItemUnchanged() | ItemSkipped():
                result.skipped += 1
